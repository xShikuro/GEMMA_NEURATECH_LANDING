  ...
  ru: {
    ...
    pricing: {
      ...
      checkout: {
        ...
        bankIntro: 'Выберите банк, через эквайринг которого будет проводиться оплата после подключения платежного шлюза.',
        bankContinueLabel: 'Перейти к данным карты',
        bankAcquiringLabel: 'Эквайринг',
        bankSelectedLabel: 'Выбранный банк',
        bankNote: 'Будет подключен отдельный банковский эквайринг.',
        paymentIntro: 'Введите платежные данные. Карта будет передаваться в выбранный банковский эквайринг без хранения на сайте.',
  ...
  en: {
    ...
    pricing: {
      ...
      checkout: {
        ...
        bankIntro: 'Choose the bank whose acquiring connection will process the payment after the payment gateway is connected.',
        bankContinueLabel: 'Continue to card details',
        bankAcquiringLabel: 'Acquiring',
        bankSelectedLabel: 'Selected bank',
        bankNote: 'A dedicated bank acquiring integration will be connected.',
        paymentIntro: 'Enter payment details. The card will be passed to the selected bank acquiring flow without being stored on the website.',
...
content.uz = {
  ...
  pricing: {
    ...
    checkout: {
      ...
      paymentTitle: 'Karta maʼlumotlari',
      ...
      bankIntro: 'To‘lov shlyuzi ulangandan so‘ng to‘lov qaysi bank ekvayringi orqali o‘tishini tanlang.',
      bankContinueLabel: 'Karta maʼlumotlariga o‘tish',
      bankAcquiringLabel: 'Ekvayring',
      bankSelectedLabel: 'Tanlangan bank',
      bankNote: 'Alohida bank ekvayring integratsiyasi ulanadi.',
      paymentIntro: 'To‘lov maʼlumotlarini kiriting. Karta saytda saqlanmasdan tanlangan bank ekvayringiga uzatiladi.',
