        ...
        {plans.map((plan) => (
          ...
          >
            ...
            {plan.features?.length ? (
              <>
                <em className="pricing-card__included">
                  {includedLabel}
                </em>
...
export default function Pricing({ copy, language }) {
  const catalog = useServicesCatalog(language, {
    pricing: copy.items,
    services: [],
  })
  ...
  return (
    <section
      className="section-block tech-frame reveal"
      id="pricing"
    >
